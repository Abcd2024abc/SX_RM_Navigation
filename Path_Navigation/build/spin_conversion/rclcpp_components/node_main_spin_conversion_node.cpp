...
#define NODE_MAIN_LOGGER_NAME "spin_conversion_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libspin_conversion_core.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spin_conversion::FakeVelTransform>";
