...
static const _SpinCommand_type_support_symbol_names_t _SpinCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spin_conversion, msg, SpinCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spin_conversion, msg, SpinCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, spin_conversion, msg, SpinCommand)() {
  return &::spin_conversion::msg::rosidl_typesupport_c::SpinCommand_message_type_support_handle;
}
