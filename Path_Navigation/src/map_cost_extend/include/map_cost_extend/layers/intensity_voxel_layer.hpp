#ifndef map_cost_extend__LAYERS__INTENSITY_VOXEL_LAYER_HPP_
#define map_cost_extend__LAYERS__INTENSITY_VOXEL_LAYER_HPP_
...
public:
  ...
  {
    costmap_ = NULL;  // 这是父类的父类 Costmap2D 的 unsigned char* 成员。
  }
...
#endif  // map_cost_extend__LAYERS__INTENSITY_VOXEL_LAYER_HPP_
