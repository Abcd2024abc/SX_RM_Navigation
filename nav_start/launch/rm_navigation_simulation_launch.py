...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory("nav_start")
    ...
    nav_decision_maker = LaunchConfiguration("nav_decision_maker")
    ...
    declare_nav_decision_maker_cmd = DeclareLaunchArgument(
        "nav_decision_maker",
        default_value="True",
        description="Whether to start the nav decision maker",
    )
    ...
    bringup_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "nav_decision_maker": nav_decision_maker,
        }.items(),
    )
    ...
    ld.add_action(declare_nav_decision_maker_cmd)
